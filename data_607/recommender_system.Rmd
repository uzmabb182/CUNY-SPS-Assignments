...
eBay uses one of the technique of recommender system, called item-based collaborative filtering.
...
conditions and provide better predictions for recommendation, like size, color, type, length entries etc. depending on the product that the user is interested in and then make recommendation.
